...
public class GeneradorDeLibros {
    ...
    public String generarAutor(){
     ...
     public  String generarTitulo(){
        String resultado="";
        Random r = new Random();
        String[] p1 = {"Luna ","Sol ","Campo ","Aceras ","Campo ","Laguna ",
                        "Perros ","Gatos ","Saltamontes ","Lapiz ","Paredes ","Luciano "
                        };
        String[] p2 = {"de ","el ","la ","los ","las ","con ","sin "};
        String[] p3 = {"Luna ","Sol ","Campo ","Aceras ","Campo ","Laguna ",
                        "Perros ","Gatos ","Saltamontes ","Lapiz ","Paredes ",
                        "Menta","Limon"
                        };
